...
Overtime as virtual machines are created and deleted dynamically in a cluster of nodes providing virtual machines, there is a possibility of a scenario where a couple of nodes's resources are completed utilized by virtual machines (VM) and at the same time there are nodes with lesser utilization. In this scenario, it is advisable to move VMs from over loaded nodes to lesser ones. 
\\\\For example, the following figure shows node N1 and N3 are fully utilized where as N2 is partially loaded. We calculate the possibility of moving some of the VMs in N1 and N3 to N2, if N2 has enough room to accommodate, a recommendation is generated to admin to initiate a move of VMs from N1 $ \rightarrow $ N2 and N3 $ \rightarrow $ N2.

\begin{figure}[H]
	\centering
	\includegraphics[scale=0.7]{movingvms}
	\caption{Normalization of resources}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Consolidation of resources}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Under provisioned hardware}
\end{figure}
